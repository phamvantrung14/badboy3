...
<div class="signup-box">
    ...
    <div class="card">
        <div class="body">
            <form id="sign_up" method="POST" action="{{route("customer.save.register")}}">
                @csrf
                @method("POST")
                ...
                <div class="input-group">
                    ...
                    <div class="form-line">
                        <input type="text" class="form-control @error("customer_name") is-invalid  @enderror" name="customer_name" placeholder="Tên Người Dùng" required autofocus>
                        @error("customer_name")
                ...
                <div class="m-t-25 m-b--5 align-center">
                    <a href="{{route("customer.login")}}">Bạn đã là thành viên?</a>
                </div>
            </form>
        </div>
    </div>
